...
![The framework plot of COMPASS](https://github.com/DARKpmm/COMPASS/blob/main/modelplot.png)
...
`COMPASS` mainly depends on the Python scientific stack.
    ...
    pandas
    scikit-learn
For specific setting, please see <a href="https://github.com/DARKpmm/COMPASS/blob/main/environment.yml">environment</a>.
