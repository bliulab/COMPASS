...
`COMPASS` mainly depends on the Python scientific stack.
    ...
    pandas
    scikit-learn
For specific setting, please see <a href="">requirements</a>.
...
* Unseen perturbation target effect prediction. The example can be seen in the <a href=""></a>
* Cross-microenvironment perturbation effect prediction. The example can be seen in the <a href=""></a>
