...
class ObservationNormalizationStatistics:
    ...
    x_adt_mean: Optional[torch.Tensor] = None
    x_adt_std: Optional[torch.Tensor] = None
    log_x_mean: Optional[torch.Tensor] = None
    log_x_std: Optional[torch.Tensor] = None
    log_x_adt_mean: Optional[torch.Tensor] = None
    log_x_adt_std: Optional[torch.Tensor] = None
    embed_mean: Optional[torch.Tensor] = None
    embed_std: Optional[torch.Tensor] = None
    log_embed_mean: Optional[torch.Tensor] = None
    log_embed_std: Optional[torch.Tensor] = None
